...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class GlideLibraryAccessors extends SubDependencyFactory {
        private final GlideXLibraryAccessors laccForGlideXLibraryAccessors = new GlideXLibraryAccessors(owner);

        public GlideLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>glide.x</b>
         */
        public GlideXLibraryAccessors getX() {
            return laccForGlideXLibraryAccessors;
        }

    }

    public static class GlideXLibraryAccessors extends SubDependencyFactory {
        private final GlideXX2LibraryAccessors laccForGlideXX2LibraryAccessors = new GlideXX2LibraryAccessors(owner);

        public GlideXLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>glide.x.x2</b>
         */
        public GlideXX2LibraryAccessors getX2() {
            return laccForGlideXX2LibraryAccessors;
        }

    }

    public static class GlideXX2LibraryAccessors extends SubDependencyFactory {

        public GlideXX2LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>x</b> with <b>com.github.bumptech.glide:glide.4.12.0</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getX() {
            return create("glide.x.x2.x");
        }
