...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.topAppBar, 1);
        sViewsWithIds.put(R.id.recyclerViewTasks, 2);
        sViewsWithIds.put(R.id.btnAddTask, 3);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.task == variableId) {
            setTask((java.lang.String) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setTask(@Nullable java.lang.String Task) {
        this.mTask = Task;
    }
